...
contract tRWA is ERC4626, ItRWA, ReentrancyGuard {
     ...
     * @param sovaBTC_ SovaBTC address for redemptions (chain-specific)
     */
    constructor(
        string memory name_,
     ...
     * @dev For multi-collateral vault, returns SovaBTC as the redemption asset
     * @return Asset of the token (SovaBTC for redemptions)
     */
    ...
    /**
     * @notice Returns the underlying asset (for backwards compatibility)
     * @return The original underlying asset address
     */
